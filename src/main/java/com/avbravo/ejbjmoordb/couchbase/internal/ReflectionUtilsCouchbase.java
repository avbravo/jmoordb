package com.avbravo.ejbjmoordb.couchbase.internal;
...
public class ReflectionUtilsCouchbase {
	...
	public static Object dbListToArrayOfPrimitives(List<JsonObject> dbList, Class<?> fieldType) {
